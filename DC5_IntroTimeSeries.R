...
rw_drift <- arima.sim(model = list(order = c(0, 1, 0)), n = 100, mean = 0.4)
...
plot.ts(cbind(white_noise, random_walk, rw_drift, rw_drift))
...
acf(stock_A, lag.max = 2, plot = TRUE)
...
## Chapter 4 The autoregressive model
...
# Chapter 5 The simple Moving Average Model
